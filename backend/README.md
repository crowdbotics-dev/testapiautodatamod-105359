...
## Project Structure
    ...
    ├── testapiautodatamod_105359  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_105359`
...
2. Clone this repo and `cd testapiautodatamod_105359`
